"""
This code is based on UniXcoder, with minor modifications to make it compatible with the CRec framework.
The original UniXcoder model and code can be found at the following link: https://github.com/microsoft/CodeBERT/tree/master/UniXcoder
"""
...
class UniXcoder(nn.Module):
    ...
    def generate(self, source_ids, decoder_only = True, eos_id = None, beam_size = 5, max_length = 64):
        ...
        pred_scores = beam.scores[:beam_size]

        return preds, pred_scores.cpu().tolist()
